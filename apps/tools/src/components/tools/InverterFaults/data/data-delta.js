export const DELTA_FAULTS = [
  {
    ...
    expertTips:
      "Trên dòng Delta MS300, biến tần phân tách chi tiết: ocA (quá dòng tăng tốc), ocd (quá dòng giảm tốc), ocn (quá dòng chạy đều). Hãy dựa vào ký tự thứ 3 để xác định chính xác giai đoạn bị lỗi.",
  ...
  },
  {
    ...
    expertTips:
      "Kích hoạt tham số 06-01 = 1 (Over-voltage stall prevention) để biến tần tự động nới dài thời gian hãm nếu áp Bus DC tăng cao.",
  ...
  },
  {
    ...
    expertTips:
      "Đọc thanh ghi 2105H để giám sát điện áp Bus DC thực tế (đơn vị: 0.1V).",
    relatedRegisters: ["2100H", "2105H"],
  },
  {
    id: "DELTA_OL",
    ...
    expertTips:
      "Mức bảo vệ quá tải điện tử được cấu hình trong nhóm tham số 06-03 đến 06-06.",
    relatedRegisters: ["2100H", "2104H"],
  },
  {
    id: "DELTA_OL2",
  ...
  },
  {
    ...
    expertTips:
      "Tham số 06-19 cấu hình hành vi của quạt làm mát (0: Tự động chạy theo nhiệt độ, 1: Luôn luôn chạy khi có điện).",
  ...
  },
  {
    ...
    expertTips:
      "Đây là cơ chế khóa liên động an toàn chủ động từ mạch điều khiển ngoài.",
    relatedRegisters: ["2100H"],
  },
  {
    id: "DELTA_GFF",
    ...
    expertTips:
      "Tuyệt đối không xóa lỗi và bật chạy lại liên tục để tránh phá hủy khối công suất IGBT.",
    relatedRegisters: ["2100H"],
  },
  {
    id: "DELTA_CE",
    ...
    expertTips:
      "Cổng RJ45 trên biến tần Delta MS300: Chân 3 là SG+, Chân 4 là SG-, Chân 5 và 6 là GND.",
  ...
  },
  {
    ...
    expertTips:
      "Tham số 06-45 cấu hình phát hiện mất pha đầu vào, tham số 06-46 cấu hình phát hiện mất pha ngõ ra.",
    relatedRegisters: ["2100H"],
  },
];
...
export const DELTA_REGISTERS = [
  {
    ...
    description:
      "Thanh ghi điều khiển lệnh chạy/dừng/hướng quay cho biến tần Delta qua Modbus RTU (Địa chỉ Hex 2000H / Dec 8192)",
    bitDetails: [
      {
        bit: "Bit 0-1 = 10B (0012H)",
        name: "RUN FWD",
        desc: "Khởi động chạy động cơ theo chiều thuận (Ghi 18 / 0012H)",
      },
      {
        bit: "Bit 4-5 = 10B (0022H)",
        name: "RUN REV",
        desc: "Khởi động chạy động cơ theo chiều ngược (Ghi 34 / 0022H)",
      },
      {
        bit: "Bit 0-1 = 01B (0001H)",
        name: "STOP",
        desc: "Lệnh giảm tốc dừng động cơ (Ghi 1 / 0001H)",
      },
      {
        bit: "Bit 1 = 1 (0002H)",
        name: "RESET",
        desc: "Lệnh xóa lỗi sự cố (Trip Reset - Ghi 2 / 0002H)",
      },
    ],
    example:
      "Chạy thuận: ghi 0012H (18). Chạy ngược: ghi 0022H (34). Dừng: ghi 0001H (1). Xóa lỗi: ghi 0002H (2).",
  },
  {
    id: "DELTA_REG_2001",
    brand: "delta",
    ...
    categoryLabel: "Lệnh điều khiển",
    description:
      "Cài đặt tần số ngõ ra mục tiêu qua Modbus (Đơn vị: 0.01 Hz). Cần cài nguồn tần số qua RS485 (00-20 = 1).",
    bitDetails: [],
  ...
  },
  {
    ...
    description:
      "Thanh ghi đọc mã lỗi và cảnh báo sự cố chuẩn của Delta MS300 (Byte thấp: Mã lỗi sự cố; Byte cao: Mã cảnh báo)",
    bitDetails: [
      {
        bit: "Low Byte = 1",
        name: "oc",
        desc: "Quá dòng ngõ ra (ocA / ocd / ocn)",
      },
      {
        bit: "Low Byte = 2",
        name: "ov",
        desc: "Quá điện áp Bus DC (ovA / ovd / ovn)",
      },
    ...
    example:
      "Đọc Function 03 địa chỉ 2100H. Nếu giá trị khác 0 thì biến tần đang báo lỗi (lấy Byte thấp & 0xFF để xem mã lỗi).",
  },
  {
    id: "DELTA_REG_2101",
    brand: "delta",
    ...
    description:
      "Thanh ghi trạng thái hoạt động của biến tần Delta (Hex 2101H / Dec 8449)",
    bitDetails: [
      {
        bit: "Bit 0-1 = 11B",
        name: "OPERATING",
        desc: "Biến tần đang chạy xuất điện áp",
      },
      {
        bit: "Bit 0-1 = 00B",
        name: "STOPPED",
    ...
    example:
      "Đọc Function 03 địa chỉ 2101H để giám sát biến tần đang chạy hay dừng.",
  },
  {
    id: "DELTA_REG_2102",
    brand: "delta",
    ...
    description:
      "Tần số mục tiêu F đang được cài đặt trong biến tần (Đơn vị: 0.01 Hz)",
    bitDetails: [],
  ...
  },
  {
    ...
    categoryLabel: "Giám sát ngõ ra",
    description:
      "Tần số ngõ ra thực tế H đang phát cho động cơ (Đơn vị: 0.01 Hz)",
    bitDetails: [],
    example: "Đọc về 5000 tương ứng 50.00 Hz.",
  },
  {
    ...
    categoryLabel: "Giám sát ngõ ra",
    description:
      "Dòng điện hiệu dụng ngõ ra cấp cho động cơ (Đơn vị: 0.01 A; nếu > 655.35A đổi sang 0.1A)",
    bitDetails: [],
