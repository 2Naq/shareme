export const KOC_FAULTS = [
  {
    ...
    expertTips:
      "Lỗi Err01/SC là cấp bảo vệ ngắt xung khẩn cấp phần cứng của biến tần.",
  ...
  },
  {
    ...
    expertTips:
      "Tăng thêm 2-3 giây cho thời gian tăng tốc để dòng đề-pa ổn định hơn.",
...
export const KOC_REGISTERS = [
  {
    ...
    description:
      "Thanh ghi điều khiển lệnh chạy/dừng/reset cho biến tần KOC qua Modbus RTU (Địa chỉ Hex 2000H / Dec 8192)",
    bitDetails: [
  ...
  },
  {
    ...
    description:
      "Mã số lỗi sự cố hiện tại của biến tần KOC (1 = Err01, 2 = Err02, 3 = Err03, 4 = Err04, 5 = Err05, 6 = Err06, 9 = Err09, 10 = Err10, 11 = Err11, 12 = Err12, 13 = Err13, 14 = Err14, 16 = Err16, 23 = Err23)",
    bitDetails: [
