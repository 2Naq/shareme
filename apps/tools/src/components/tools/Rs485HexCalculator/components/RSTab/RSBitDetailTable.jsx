      ...
      <CardContent className="overflow-x-auto">
        <Table className="border">
          <TableHeader className="bg-muted/50">
            <TableRow>
              <TableHead rowSpan={2} className="text-foreground w-25 border-r font-bold">
                Bit No.
              </TableHead>
              <TableHead rowSpan={2} className="text-foreground w-45 border-r font-bold">
                Name
              </TableHead>
              <TableHead colSpan={2} className="text-foreground border-b text-center font-bold">
                Description
              </TableHead>
            </TableRow>
            <TableRow>
          ...
          <TableBody>
            ...
            <TableRow className="bg-primary/5 transition-colors">
              ...
              <TableCell className="border-r font-medium">Data length</TableCell>
              <TableCell
                className={`border-r text-center transition-colors ${
                  dataLength === "0" ? "bg-primary/15 text-primary font-bold" : ""
                }`}
              >
                7 bit
              </TableCell>
              <TableCell
                className={`text-center transition-colors ${
                  dataLength === "1" ? "bg-primary/15 text-primary font-bold" : ""
                }`}
              >
                8 bit
              </TableCell>
            ...
            <TableRow className="bg-primary/5 transition-colors">
              ...
              <TableCell colSpan={2}>
                <div className="space-y-1 font-mono text-xs">
                  <div className="text-muted-foreground font-semibold">b2 b1</div>
                  <div
                    className={`rounded px-1 transition-colors ${
                      parity === "00" ? "bg-primary/15 text-primary font-bold" : ""
                    }`}
                  >
                    (0, 0) : None
                  </div>
                  <div
                    className={`rounded px-1 transition-colors ${
                      parity === "01" ? "bg-primary/15 text-primary font-bold" : ""
                    }`}
                  >
                    (0, 1) : Odd (Lẻ)
                  </div>
                  <div
                    className={`rounded px-1 transition-colors ${
                      parity === "11" ? "bg-primary/15 text-primary font-bold" : ""
                    }`}
                  >
                    (1, 1) : Even (Chẵn)
                  </div>
            ...
            <TableRow className="bg-primary/5 transition-colors">
              ...
              <TableCell className="border-r font-medium">Baud rate (bps)</TableCell>
              <TableCell colSpan={2}>
                <div className="space-y-1 font-mono text-xs">
                  <div className="text-muted-foreground mb-1 font-semibold">b7 b6 b5 b4</div>
                  <div className="grid grid-cols-1 gap-x-6 gap-y-1 sm:grid-cols-2">
                    <div
                      className={`rounded px-1 transition-colors ${
                        baud === "0011" ? "bg-primary/15 text-primary font-bold" : ""
                      }`}
                    >
                      &#123;0, 0, 1, 1&#125;: 300
                    </div>
                    <div
                      className={`rounded px-1 transition-colors ${
                        baud === "0111" ? "bg-primary/15 text-primary font-bold" : ""
                      }`}
                    >
                      &#123;0, 1, 1, 1&#125;: 4800
                    </div>
                    <div
                      className={`rounded px-1 transition-colors ${
                        baud === "0100" ? "bg-primary/15 text-primary font-bold" : ""
                      }`}
                    >
                      &#123;0, 1, 0, 0&#125;: 600
                    </div>
                    <div
                      className={`rounded px-1 transition-colors ${
                        baud === "1000" ? "bg-primary/15 text-primary font-bold" : ""
                      }`}
                    >
                      &#123;1, 0, 0, 0&#125;: 9600
                    </div>
                    <div
                      className={`rounded px-1 transition-colors ${
                        baud === "0101" ? "bg-primary/15 text-primary font-bold" : ""
                      }`}
                    >
                      &#123;0, 1, 0, 1&#125;: 1200
                    </div>
                    <div
                      className={`rounded px-1 transition-colors ${
                        baud === "1001" ? "bg-primary/15 text-primary font-bold" : ""
                      }`}
                    >
                      &#123;1, 0, 0, 1&#125;: 19200
                    </div>
                    <div
                      className={`rounded px-1 transition-colors ${
                        baud === "0110" ? "bg-primary/15 text-primary font-bold" : ""
                      }`}
                    >
                      &#123;0, 1, 1, 0&#125;: 2400
                    </div>
            ...
            <TableRow className="bg-primary/5 transition-colors">
              ...
              >
                Effective (D8124)<br />
                <span className="text-muted-foreground text-xs">Default: STX (02H)</span>
              </TableCell>
            </TableRow>
            ...
            <TableRow className="bg-primary/5 transition-colors">
              ...
              <TableCell
                className={`border-r text-center transition-colors ${
                  terminator === "0" ? "bg-primary/15 text-primary font-bold" : ""
                }`}
              >
                None
              </TableCell>
              <TableCell
                className={`text-center transition-colors ${
                  terminator === "1" ? "bg-primary/15 text-primary font-bold" : ""
                }`}
              >
                Effective (D8125)<br />
                <span className="text-muted-foreground text-xs">Default: ETX (03H)</span>
              </TableCell>
            </TableRow>
            ...
            <TableRow className="bg-primary/5 transition-colors">
              ...
              <TableCell className="border-r font-medium">Control line</TableCell>
              <TableCell colSpan={2}>
                <div className="space-y-2 font-mono text-xs">
                  ...
                  <div>
                    <div
                      className={`mb-1 font-semibold ${
                        protocol === "0" ? "text-primary" : "text-muted-foreground"
                      }`}
                    >
                    ...
                    <div className="space-y-1">
                      ...
                      >
                        &#123;0, 1, 0&#125;: Interlink mode (RS-232C, FX2N V2.00+)
                      </div>
                      <div
                        className={`rounded px-1 transition-colors ${
                      ...
                      >
                        &#123;1, 0, 1&#125;: Normal mode 2 (RS-232C, FX/FX2c only)
                      </div>
                    </div>
                  </div>
                  {/* Computer link mode */}
                  <div className="border-t pt-2">
                    <div
                      className={`mb-1 font-semibold ${
                        protocol === "1" ? "text-primary" : "text-muted-foreground"
                      }`}
                    >
            ...
            <TableRow className="bg-primary/5 transition-colors">
              ...
              <TableCell className="border-r font-medium">Transmission control</TableCell>
              <TableCell
                className={`border-r text-center transition-colors ${
                  transmissionControl === "0" ? "bg-primary/15 text-primary font-bold" : ""
                }`}
              >
                Protocol format 1
              </TableCell>
              <TableCell
                className={`text-center transition-colors ${
                  transmissionControl === "1" ? "bg-primary/15 text-primary font-bold" : ""
                }`}
              >
                Protocol format 4
              </TableCell>
