  ...
  return (
    <Card>
      <CardContent className="p-5 space-y-4">
        ...
        <div className="space-y-2">
          <Label className="text-sm font-semibold">
            2. Họa tiết viền mắt (Corners Square):
          </Label>
          <Select value={cornersType} onValueChange={setCornersType}>
            ...
            <SelectContent>
              ...
              <SelectItem value="extra-rounded">
                Khung bo góc lớn (Extra Rounded)
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
