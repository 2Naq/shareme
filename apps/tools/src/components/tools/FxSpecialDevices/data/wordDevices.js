...
export const WORD_DEVICES = [
  ...
  // ==========================================
  {
    ...
    category: "system",
    rw: "R/W",
    summary: "Cài đặt thời gian giám sát Watchdog Timer (Mặc định: 200ms, bước đặt: 1ms).",
    description:
    ...
    ladderExample: "|--[ M8002 ]-----------------[ MOV K500 D8000 ]--| // Nâng WDT lên 500ms",
    notes: "Có thể ghi đè giá trị mới bằng chương trình (có hiệu lực sau lệnh END hoặc lệnh WDT).",
  ...
  },
  {
    ...
    category: "system",
    rw: "R",
    summary: "Lưu mã loại dòng PLC (Model type) và phiên bản hệ điều hành CPU (Version 1.00 = 100).",
    description:
    ...
    notes: "Dùng để đọc model và phiên bản PLC lên màn hình HMI hoặc phần mềm giám sát SCADA.",
  ...
  },
  {
    ...
    category: "system",
    rw: "R",
    summary: "Dung lượng bộ nhớ chương trình đang sử dụng (2: 2K, 4: 4K, 8: 8K, 16+: xem D8102).",
    description:
  ...
  },
  {
    ...
    category: "system",
    rw: "R",
    summary: "Loại bộ nhớ chương trình và trạng thái công tắc chống ghi Protect Switch.",
    description:
  ...
  },
  {
    ...
    category: "error",
    rw: "R",
    summary: "Lưu số hiệu cờ M gây ra lỗi khi cờ M8004 bật ON (Ví dụ: 8060, 8064, 8067...).",
    description:
  ...
  },
  {
    ...
    category: "system",
    rw: "R",
    summary: "Điện áp hiện tại của pin nuôi bộ nhớ PLC (Đơn vị: 0.1V, ví dụ: 30 = 3.0V).",
    description:
    ...
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8005 D20 ]--| // Hiển thị Volt pin lên HMI",
    notes: "Khi D8005 giảm xuống dưới giá trị cài tại D8006, cờ M8005 sẽ tự động bật ON.",
  ...
  },
  {
    ...
    category: "system",
    rw: "R/W",
    summary: "Ngưỡng điện áp phát hiện lỗi pin yếu (Mặc định: 2.7V trên FX3 series, 3.0V trên FX2N).",
    description:
  ...
  },
  {
    ...
    description: "Lưu tổng số lần hệ thống ghi nhận có sự cố sụt nguồn thoáng qua.",
    initialValue: "0",
  ...
  },
  {
    ...
    category: "system",
    rw: "R/W",
    summary: "Thời gian phát hiện mất nguồn điện chính (Mặc định: 10ms đối với nguồn AC, 5ms đối với nguồn DC).",
  ...
  },
  {
    ...
    description: "Lưu địa chỉ ngõ vào X thấp nhất của khối mở rộng phát sinh sự cố mất nguồn 24V DC cấp ngoài.",
    initialValue: "0",
  ...
  },
  {
    ...
    category: "system",
    rw: "R",
    summary: "Thời gian quét (Scan Time) của vòng quét hiện tại (Đơn vị: 0.1ms).",
    description:
    ...
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8010 D50 ]--| // Đọc thời gian quét ms",
    notes: "Bao gồm cả thời gian chờ nếu đang kích hoạt chế độ Constant Scan (M8039).",
  ...
  },
  {
    ...
    category: "system",
    rw: "R",
    summary: "Thời gian quét ngắn nhất ghi nhận được kể từ khi RUN (Đơn vị: 0.1ms).",
    description: "Lưu giá trị scan time nhỏ nhất đã diễn ra từ thời điểm PLC chuyển sang chế độ RUN.",
  ...
  },
  {
    ...
    category: "system",
    rw: "R",
    summary: "Thời gian quét dài nhất ghi nhận được kể từ khi RUN (Đơn vị: 0.1ms).",
    description: "Lưu giá trị scan time đỉnh tải lớn nhất kể từ lúc RUN. Giúp phát hiện các chu kỳ quét bị quá tải để kịp thời tối ưu chương trình trước khi chạm ngưỡng WDT (D8000).",
    initialValue: "0.1ms unit",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8012 D52 ]--|",
    notes: "Nếu D8012 tăng cao tiệm cận mức 200ms của D8000, cần tối ưu lại cấu trúc chương trình.",
  ...
  },
  {
    ...
    category: "system",
    rw: "R/W",
    summary: "Cài đặt độ dài chu kỳ quét cố định cho chế độ Constant Scan M8039 (Đơn vị: 1ms, mặc định: 0ms).",
    description: "Khi M8039 = ON, giá trị nạp trong D8039 quy định thời gian của mỗi chu kỳ quét (đơn vị: 1ms).",
    initialValue: "0 (ms)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K15 D8039 ]--| // Đặt scan time cố định 15ms",
  ...
  // ==========================================
  {
    ...
    description: "Lưu trữ giá trị Giây hiện tại từ vi mạch đồng hồ thời gian thực RTC (dải giá trị 0 đến 59).",
    initialValue: "0 - 59",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8013 D10 ]--|",
    notes: "Có thể ghi giá trị mới vào D8013 khi M8015 = ON để chỉnh lại đồng hồ.",
  ...
  },
  {
    ...
    description: "Lưu trữ giá trị Phút hiện tại từ IC đồng hồ thời gian thực RTC (dải giá trị 0 đến 59).",
    initialValue: "0 - 59",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    description: "Lưu trữ giá trị Giờ hiện tại theo định dạng 24 giờ (dải giá trị 0 đến 23).",
    initialValue: "0 - 23",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[== D8015 K8 ]------------[ OUT Y0 ]--| // Bật thiết bị lúc 8h sáng",
  ...
  },
  {
    ...
    description: "Lưu trữ giá trị Ngày trong tháng của đồng hồ thời gian thực (dải giá trị 1 đến 31).",
    initialValue: "1 - 31",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8016 D13 ]--|",
    notes: "Đồng hồ tự động tính toán số ngày chính xác theo các tháng 28, 29, 30, 31 ngày.",
  ...
  },
  {
    ...
    description: "Lưu trữ giá trị Tháng hiện tại từ đồng hồ thời gian thực (dải giá trị 1 đến 12).",
    initialValue: "1 - 12",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8017 D14 ]--|",
    notes: "Kết hợp với D8016, D8018 để ghi nhận thời gian sự kiện (Datalogging).",
  ...
  },
  {
    ...
    description: "Lưu trữ 2 chữ số cuối của năm (0 đến 99, ví dụ: 26 đại diện cho năm 2026). Dải 00-79 được hiểu là 2000-2079, dải 80-99 là 1980-1999.",
    initialValue: "00 - 99",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[== D8019 K0 ]------------[ OUT Y5 ]--| // Tắt máy tự động vào Chủ Nhật",
    notes: "Tiện lợi lập trình điều khiển bật/tắt thiết bị theo lịch nghỉ cuối tuần.",
  ...
  // ==========================================
  {
    ...
    category: "system",
    rw: "R/W",
    summary: "Cài đặt hằng số thời gian lọc ngõ vào số X000 ~ X017 (Mặc định: 10ms, dải đặt: 0 đến 60ms).",
    description: "Cho phép điều chỉnh bộ lọc chống nhiễu phần cứng cho các ngõ vào X000-X017. Đặt 0ms cho ngõ vào đáp ứng nhanh cực đại.",
    initialValue: "10 (ms)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K1 D8020 ]--| // Đặt lọc ngõ vào 1ms",
    notes: "Dùng để lọc rung tiếp điểm công tắc hành trình hoặc nâng tốc độ nhận xung.",
  ...
  },
  {
    ...
    description: "Lưu giá trị số nguyên từ 0 đến 255 tương ứng với vị trí xoay của biến trở chiết áp VR1 trên mặt trước PLC.",
    initialValue: "0 - 255",
    applicableModels: "FX3S, FX3G, FX1S, FX1N",
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8030 D100 ]--| // Đọc núm xoay cài Timer",
    notes: "Rất tiện lợi để người vận hành chỉnh thời gian Timer trực tiếp bằng tua-vít mà không cần màn hình HMI.",
  ...
  },
  {
    ...
    description: "Lưu giá trị số nguyên từ 0 đến 255 từ biến trở chiết áp VR2 trên mặt trước PLC.",
    initialValue: "0 - 255",
    applicableModels: "FX3S, FX3G, FX1S, FX1N",
  ...
  // ==========================================
  {
    ...
    category: "error",
    rw: "R",
    summary: "Mã lỗi cấu hình I/O (Lưu địa chỉ khối I/O bị xung đột hoặc không gắn).",
    description: "Theo tài liệu Mitsubishi: [D]8060 lưu địa chỉ thiết bị I/O đầu tiên của khối phần cứng phát sinh lỗi (khi cờ M8060 bật ON).",
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3G, FX3GC, FX3U, FX3UC, FX2N, FX2NC",
  ...
  },
  {
    ...
    category: "error",
    rw: "R",
    summary: "Mã lỗi phần cứng PLC (Lưu mã lỗi CPU/RAM/Nguồn khi M8061 bật ON).",
    description:
  ...
  },
  {
    ...
    category: "comm",
    rw: "R",
    summary: "Mã lỗi truyền thông cổng lập trình USB/RS-422 Ch0 (khi M8062 bật ON).",
    description: "Lưu mã lỗi kết nối với máy tính nạp chương trình hoặc HMI qua cổng tròn Ch0 (Ví dụ: 6201 Parity error, 6202 Overrun...).",
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    description: "Lưu chi tiết mã lỗi khi các thông số hệ thống bị cài đặt sai dải (Ví dụ: 6401 lỗi dải bộ nhớ, 6402 lỗi tham số truyền thông...).",
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    description: "Lưu mã lỗi cú pháp câu lệnh trong chương trình. Vị trí bước lệnh lỗi được lưu tại D8069.",
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    description: "Lưu mã lỗi cấu trúc mạch Ladder. Vị trí bước lệnh lỗi được lưu tại D8069.",
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    category: "error",
    rw: "R/W",
    summary: "Lưu chốt số thứ tự bước lệnh (Step No) phát sinh lỗi tính toán đầu tiên.",
    description: "Chốt lưu số bước lệnh của câu lệnh gây ra lỗi tính toán đầu tiên kể từ khi chuyển sang RUN.",
    initialValue: "0",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    category: "error",
    rw: "R",
    summary: "Lưu số thứ tự bước lệnh (Step number) phát sinh lỗi cú pháp / ladder / tính toán.",
    description:
    ...
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8067 ]-----------------[ MOV D8069 D509 ]--| // Tìm vị trí dòng lỗi",
    notes: "Nếu chương trình vượt quá 32K bước (FX3U), bước lệnh lỗi được lưu tại D8314 và D8315 (32-bit).",
  ...
  },
  {
    ...
    category: "error",
    rw: "R/W",
    summary: "Bước lệnh phát sinh lỗi tính toán chốt (16-bit thấp) cho chương trình lớn > 32K steps.",
    description: "Kết hợp với D8313 tạo thành số nguyên 32-bit lưu bước lệnh lỗi cho dòng FX3U/FX3UC.",
    initialValue: "0",
  ...
  // ==========================================
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Thanh ghi cấu hình định dạng truyền thông nối tiếp Kênh 1 (Baudrate, Parity, Data length, Stop bit, Protocol).",
    description:
    ...
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV H0081 D8120 ]--| // 9600-8-N-1",
    notes: "Có tính chất lưu giữ nhớ (Latch/EEPROM). Cần khởi tạo bằng xung M8002 và tắt/bật lại nguồn PLC sau khi thay đổi.",
    tags: ["d8120", "comm format", "baudrate", "parity", "stop bit", "rs485", "modbus", "ch1"],
  },
  {
    id: "D8121",
    ...
    category: "comm",
    rw: "R/W",
    summary: "Cài đặt số trạm (Station number) cho giao thức Computer Link trên Kênh 1 (0 đến 15).",
    description: "Cài đặt địa chỉ trạm của PLC khi giao tiếp qua mạng Computer Link trên cổng Ch1.",
    initialValue: "0",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K1 D8121 ]--| // Trạm số 1",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R",
    summary: "Số lượng byte dữ liệu còn lại trong hàng đợi chưa phát xong qua Ch1.",
    description: "Lưu số điểm (byte) dữ liệu còn lại trong bộ đệm phát của lệnh RS (FNC 80) chưa được đẩy ra đường truyền serial. Đếm lùi về 0 khi hoàn tất gửi.",
    initialValue: "0 (byte)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R",
    summary: "Số lượng byte dữ liệu mà PLC đã nhận được thành công từ đường truyền Ch1.",
    description: "Lưu tổng số byte dữ liệu mà khối nhận của lệnh RS (FNC 80) đã thu nạp vào mảng Receive Buffer.",
    initialValue: "0 (byte)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8123 ]-----------------[ MOV D8123 D21 ]--| // Kiểm tra chiều dài gói tin",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Ký tự Header mở đầu khung truyền Non-protocol (Mặc định: STX = 02H).",
    description: "Nạp mã ký tự Header khởi đầu frame khi bit b8 của thanh ghi D8120 = 1. Giá trị mặc định là 0002H (ký tự STX).",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Ký tự Terminator kết thúc khung truyền Non-protocol (Mặc định: ETX = 03H).",
    description: "Nạp mã ký tự Terminator định giới kết thúc frame khi bit b9 của thanh ghi D8120 = 1. Giá trị mặc định là 0003H (ký tự ETX).",
    initialValue: "H0003 (ETX)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV H0003 D8125 ]--|",
    notes: "Trong cấu hình Modbus RTU chuẩn, không sử dụng Terminator (b9 = 0).",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Cài đặt khoảng thời gian Timeout chờ phản hồi trên Ch1 (Đơn vị: 10ms hoặc 1ms).",
    description: "Quy định thời gian tối đa PLC chờ nhận đủ gói tin phản hồi từ Slave. Nếu quá thời gian này mà không nhận đủ byte, cờ M8129 sẽ tự động bật ON.",
    initialValue: "100 - 500 (ms)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K20 D8129 ]--| // Đặt Timeout 200ms",
    notes: "Có tính chất lưu giữ nhớ (Latch/EEPROM).",
  ...
  // ==========================================
  {
    ...
    description: "Quy định vai trò và số thứ tự trạm của PLC trong mạng truyền thông N:N Network (0 là trạm chủ Master, từ 1 đến 7 là trạm tớ Slave).",
    initialValue: "0 (Master)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K0 D8176 ]--| // Đặt PLC làm Master",
  ...
  },
  {
    ...
    description: "Cài đặt số lượng trạm con Slave tham gia trao đổi dữ liệu trong mạng N:N (chỉ cài đặt trên trạm Master).",
    initialValue: "1 - 7",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K3 D8177 ]--| // Mạng gồm 3 Slave",
  ...
  },
  {
    ...
    description: "Quy định số lượng thanh ghi D và bit M tự động đồng bộ giữa các trạm PLC (Pattern 0: 4 thanh ghi D, Pattern 1: 32 bit M + 4 thanh ghi D, Pattern 2: 64 bit M + 8 thanh ghi D).",
    initialValue: "0, 1, 2",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC, FX2N, FX2NC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K1 D8178 ]--| // Chọn Pattern 1",
  ...
  // ==========================================
  {
    ...
    category: "analog",
    rw: "R",
    summary: "Giá trị số ngõ vào Analog Kênh 1 (0-4000) từ Bo BD1 (FX3S/3G) hoặc Adapter 1 (FX3U).",
    description: "Lưu giá trị số chuyển đổi Analog Kênh 1 (0-4000 tương ứng 0-10V hoặc 4-20mA).",
    initialValue: "0 - 4000",
  ...
  },
  {
    ...
    category: "analog",
    rw: "R",
    summary: "Giá trị số ngõ vào Analog Kênh 2 (0-4000) từ Bo BD1 hoặc Adapter 1.",
  ...
  },
  {
    ...
    category: "analog",
    rw: "R",
    summary: "Giá trị số ngõ vào Analog Kênh 1 (0-4000) từ bo/adapter Analog FX3U-4AD-ADP.",
    description:
    ...
    initialValue: "0 - 4000",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8000 ]-----------------[ MOV D8280 D100 ]--| // Đọc trực tiếp không cần FROM/TO",
    notes: "Đọc trực tiếp dữ liệu từ thanh ghi đặc biệt mà không cần sử dụng lệnh FROM/TO.",
  ...
  },
  {
    ...
    description: "Lưu giá trị số chuyển đổi kênh 2 ngõ vào Analog (0-4000) từ bo mở rộng hoặc adapter kết nối bên trái PLC.",
    initialValue: "0 - 4000",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
  ...
  // ==========================================
  {
    ...
    rw: "R/W",
    summary: "Thanh ghi lưu vị trí xung hiện tại trục Y000 (16-bit thấp, kết hợp với D8341 thành số 32-bit).",
    description:
    ...
    ladderExample: "|--[ DMOV D8340 D200 ]--------------------------| // Đọc vị trí 32-bit trục 1",
    notes: "Có thể dùng lệnh DMOV để ghi đè vị trí mới (ví dụ: Reset vị trí về 0 sau khi hoàn tất về gốc Home Return DSZR/ZRN).",
    tags: ["d8340", "y000", "current value", "pulse count", "position", "servo", "motion"],
  },
  {
    id: "D8341",
    ...
    description: "16-bit cao của thanh ghi vị trí hiện tại trục Y000. Kết hợp cùng D8340 tạo thành số nguyên có dấu 32-bit từ -2,147,483,648 đến +2,147,483,647 xung.",
    initialValue: "0",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC",
    ladderExample: "|--[ DMOV K0 D8340 ]----------------------------| // Reset vị trí trục Y000 về 0",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Tốc độ khởi động (Bias speed) khi phát xung định vị trên trục Y000 (Đơn vị: Hz, mặc định: 0Hz).",
    description: "Quy định tần số phát xung khởi đầu và kết thúc khi chạy các lệnh định vị.",
    initialValue: "0 (Hz)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K500 D8342 ]--| // Đặt tốc độ khởi động 500Hz",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Tốc độ tối đa cho phép trên trục Y000 (16-bit thấp, mặc định: 100,000 Hz).",
    description: "Kết hợp với D8344 tạo thành số 32-bit (D8344, D8343) giới hạn tốc độ tối đa cho trục Y000 (lên đến 100 kHz trên FX3G, 200 kHz trên FX3U).",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Tốc độ bò Creep Speed khi chạm cảm biến gốc trong lệnh về gốc DSZR (Mặc định: 1000 Hz).",
    description: "Tốc độ di chuyển chậm chính xác sau khi chạm cữ DOG để tìm tín hiệu điểm 0 (Zero point/Z-phase).",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Tốc độ chạy nhanh về gốc Home Return trục Y000 (32-bit: D8347, D8346, mặc định: 50,000 Hz).",
    description: "Tốc độ di chuyển hành trình dài trước khi chạm cảm biến gốc DOG.",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Thời gian tăng tốc khi phát xung định vị trục Y000 (Đơn vị: ms, mặc định: 100ms).",
    description: "D8348 quy định thời gian tăng tốc từ tốc độ khởi động Bias Speed lên tốc độ tối đa Maximum Speed trên trục Y000. Mặc định là 100ms.",
    initialValue: "100 (ms)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K200 D8348 ]--| // Đặt tăng tốc 200ms",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Thời gian giảm tốc khi phát xung định vị trục Y000 (Đơn vị: ms, mặc định: 100ms).",
    description: "D8349 quy định thời gian giảm tốc từ tốc độ tối đa về 0 khi dừng định vị trên trục Y000. Mặc định là 100ms.",
    initialValue: "100 (ms)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K150 D8349 ]--| // Đặt giảm tốc 150ms",
    notes: "Áp dụng cho các lệnh phát xung định vị tốc độ cao.",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Thanh ghi lưu vị trí xung hiện tại trục Y001 (16-bit thấp, kết hợp với D8351 thành 32-bit).",
    description: "D8350 (16-bit thấp) kết hợp với D8351 (16-bit cao) tạo thành cặp thanh ghi 32-bit (D8351, D8350) lưu vị trí xung tọa độ hiện tại của trục ngõ ra Y001.",
    initialValue: "0 (32-bit: D8351, D8350)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC",
    ladderExample: "|--[ DMOV D8350 D202 ]--------------------------| // Đọc vị trí trục Y001",
    notes: "Đọc và cập nhật vị trí tọa độ trục Y001.",
    tags: ["d8350", "y001", "current value", "pulse count", "position", "servo"],
  },
  {
    id: "D8351",
    ...
    description: "16-bit cao của thanh ghi vị trí hiện tại trục Y001. Kết hợp cùng D8350 tạo thành số 32-bit có dấu.",
    initialValue: "0",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC, FX1S, FX1N, FX1NC",
    ladderExample: "|--[ DMOV K0 D8350 ]----------------------------| // Reset vị trí trục Y001 về 0",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Thanh ghi lưu vị trí xung hiện tại trục Y002 (16-bit thấp, kết hợp với D8361 thành 32-bit).",
  ...
  },
  {
    ...
    category: "positioning",
    rw: "R/W",
    summary: "Thanh ghi lưu vị trí xung hiện tại trục Y003 (16-bit thấp, kết hợp với D8371 thành 32-bit).",
    description: "Lưu tọa độ vị trí xung hiện tại của trục thứ 4 (Y003) trên FX3U/FX3UC.",
    initialValue: "0",
    applicableModels: "FX3U, FX3UC",
  ...
  },
  {
    ...
    category: "clock",
    rw: "R/W",
    summary: "Bộ đếm vòng thời gian độ phân giải 1ms (16-bit thấp, kết hợp với D8399 thành số 32-bit).",
    description: "Tự động đếm tăng từ 0 đến 2,147,483,647 (32-bit) mỗi 1ms khi cờ M8398 bật ON.",
    initialValue: "0",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ DMOV D8398 D300 ]--------------------------| // Đọc mili-giây chuẩn xác",
  ...
  // ==========================================
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Thanh ghi cấu hình định dạng truyền thông cho lệnh RS2 (FNC 87) hoặc kênh MODBUS Ch1.",
    description:
    ...
    initialValue: "H0000",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV H0081 D8400 ]--| // 9600-8-N-1 cho RS2",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Cài đặt giao thức MODBUS Ch1 (H0000: Modbus RTU Master, H0001: Modbus RTU Slave).",
    description: "Quy định chế độ hoạt động Master hay Slave cho cổng Modbus Ch1.",
    initialValue: "H0000 (Master)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV H0000 D8401 ]--| // Chạy Modbus Master",
  ...
  },
  {
    ...
    description: "Lưu mã lỗi chi tiết khi xảy ra sự cố trong quá trình truyền nhận theo giao thức MODBUS trên cổng Ch1.",
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R",
    summary: "Hiển thị thông số tham số truyền thông thực tế đang hoạt động trên Kênh 1.",
    description: "[D]8405 hiển thị các tham số phần cứng thực tế mà cổng truyền thông Ch1 đang áp dụng.",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Thời gian chờ Slave phản hồi trong giao tiếp MODBUS Ch1 (Đơn vị: ms, mặc định: 500ms).",
    description: "Quy định thời gian tối đa Master chờ frame phản hồi từ thiết bị Slave trước khi báo lỗi Timeout (M8409).",
    initialValue: "500 (ms)",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K300 D8409 ]--| // Đặt Timeout 300ms",
  ...
  },
  {
    ...
    description: "Cài đặt địa chỉ ID trạm khi PLC đóng vai trò là Modbus RTU Slave trên cổng Ch1.",
    initialValue: "1",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
    ladderExample: "|--[ M8002 ]-----------------[ MOV K1 D8414 ]--| // Trạm Modbus Slave số 1",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R",
    summary: "Hiển thị chế độ hoạt động của Kênh truyền thông 1 (Non-protocol, Computer Link, Modbus...).",
    description: "[D]8419 cho biết chế độ giao tiếp hiện thời của cổng truyền thông Ch1 đang được cấu hình chạy theo kiểu nào.",
    initialValue: "Read only display",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
  ...
  },
  {
    ...
    category: "comm",
    rw: "R/W",
    summary: "Thanh ghi cấu hình định dạng truyền thông nối tiếp Kênh 2 (BD2 hoặc ADP2).",
    description: "Cấu hình 16-bit cho cổng truyền thông thứ 2 (Baudrate, Parity, Stop bit, Mode).",
    initialValue: "H0000",
  ...
  },
  {
    ...
    description: "Lưu mã lỗi chi tiết khi xảy ra sự cố trong truyền nhận Modbus cổng Ch2.",
    initialValue: "0 (Không lỗi)",
    applicableModels: "FX3G, FX3GC, FX3U, FX3UC",
  ...
  },
  {
    ...
    description: "Lưu chi tiết mã lỗi khi phát sinh sự cố giao tiếp qua cổng Mini-USB trên PLC.",
    initialValue: "0",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
  ...
  },
  {
    ...
    description: "Lưu chi tiết mã lỗi khi các tham số đặc biệt (Ethernet, Analog, Motion) bị lỗi.",
    initialValue: "0",
    applicableModels: "FX3S, FX3G, FX3GC, FX3U, FX3UC",
