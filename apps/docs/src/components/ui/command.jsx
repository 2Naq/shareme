    ...
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      ...
      >
        <CommandPrimitive.Input
          ...
          className={cn(
            "w-full flex-1 border-0! bg-transparent! px-2.5 py-1 text-sm shadow-none! ring-0! outline-hidden focus:outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
            className,
          )}
          {...props}
        />
